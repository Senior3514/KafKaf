...
const TRANSLATIONS = {
  he: {
    ...
    send_aria: "שליחה",
    error_prefix: "שגיאה",
    approval_prompt_prefix: "המודל מבקש להריץ פעולה שדורשת אישור:",
    approval_approve_btn: "אישור והרצה",
    approval_deny_btn: "דחייה",
    ...
    write_skills_heading: "הרשאת סקילים שכותבים (files, journal, זהות, תזכורות, תזמון)",
    write_skills_mode_manual: "ידני",
    write_skills_mode_assisted: "מסויע",
    write_skills_mode_autonomous: "אוטונומי",
    write_skills_hint: "חוגה נפרדת מרמת האוטונומיה — קובעת ספציפית אם סקילים שיכולים לשנות מידע (לא כולל סקילים לקריאה בלבד) מותרים.",
  ...
  en: {
    ...
    send_aria: "Send",
    error_prefix: "Error",
    approval_prompt_prefix: "The model wants to run an action that needs approval:",
    approval_approve_btn: "Approve & run",
    approval_deny_btn: "Deny",
    ...
    write_skills_heading: "Write-capable skills permission (files, journal, identity, reminders, schedule)",
    write_skills_mode_manual: "Manual",
    write_skills_mode_assisted: "Assisted",
    write_skills_mode_autonomous: "Autonomous",
    write_skills_hint: "A separate dial from the autonomy level — specifically controls whether skills that can change data (not read-only ones) are allowed.",
